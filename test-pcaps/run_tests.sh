...
function test_gtpu_filter()
{
	...
	test_file[0]=ipv4_gtpu_fragmented.pcap
	pcap_filter[0]="host 100.2.1.11 && port 1616 && host 37.37.37.61 && port 80"
	tshark_filter[0]="ip.addr==100.2.1.11 && tcp.port==1616 && ip.addr==37.37.37.61 && tcp.port==80"
	tshark_dissect_opt[0]="-o ip.defragment:FALSE"     # this is needed or otherwise tshark will save into output reassembled IP packets!
